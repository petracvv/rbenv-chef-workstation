...
if [[ $RBENV_VERSION == chef-workstation ]]; then
  if [ ! -x "$RBENV_COMMAND_PATH" ]; then
    ...
    if [ -x "${HOME}/.chefdk-workstation/gem/ruby/${chef_workstation_ruby_lib_version}/bin/${RBENV_COMMAND}" ]; then
      RBENV_COMMAND_PATH="${HOME}/.chefdk-workstation/gem/ruby/${chef_workstation_ruby_lib_version}/bin/${RBENV_COMMAND}"
